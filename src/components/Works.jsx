    ...
    >
      ...
      >
        <div className="relative w-full h-[230px]">
          ...
          <div className="absolute inset-0 flex obect-cover justify-end m-3 card-img_hover">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          {tags.map((tag) => (
            <p key={`tag.name`} 
              className={`text-14[px] ${tag.color}`}> #{tag.name} </p>
          ))}
        </div>
      </Tilt>
    </motion.div>
    ...
    <>
      <motion.div variants={textVariant()}> 
        ...
        <div className='w-full flex'>
          ...
          >
            Following projects showcase my skills and experience in web development.
